...
$config['auth_override_class_method']['api']['login'] = 'none';
$config['auth_override_class_method']['api']['forgotPassword'] = 'none';
$config['auth_override_class_method']['api']['register'] = 'none';
$config['auth_override_class_method']['api']['getOptions'] = 'none';
$config['auth_override_class_method']['api']['checkName'] = 'none';
$config['auth_override_class_method']['api']['checkEmail'] = 'none';
$config['auth_override_class_method']['api']['testAddDevice'] = 'none';
...
|
*/
$config['rest_keys_table'] = 'user_keys';

                    ...
                    <div class="owl-carousel owl-theme owl_gallerys">
                        ...
                        <?php if(!empty($images)) {
                            foreach ($images as $image) {
                                ?>
                                <div class="item">
                                    <a data-fancybox="gallery" href="<?php echo base_url();?>uploads/photo/<?php echo $image->image;?>"><img src="<?php echo base_url();?>/uploads/raw_photo/<?php echo $image->image;?>" alt="" class="img-responsive"></a>

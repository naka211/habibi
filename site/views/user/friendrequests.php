                                            ...
                                            <div class="frend_item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-ms-9 col-xs-9">
                                                        ...
                                                        <a href="<?php echo site_url('user/acceptAddFriend/' . $user->id); ?>"
                                                           class="btn bntMessage">Acceptere</a>
                                                        <a href="<?php echo site_url('user/rejectAddFriend/' . $user->id); ?>"
                                                           class="btn bntReject">Afvise</a>
                                                        <a href="<?php echo site_url('user/blockUser/' . $user->id); ?>"
                                                           class="btn bntBlock">Blok</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

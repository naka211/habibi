                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-ms-4 col-xs-12 photo<?php echo $image->id;?>">
                        <div class="box_favorites_item">
                            <div class="favorites_img">
                                ...
                                <a data-fancybox="gallery" href="<?php echo base_url();?>uploads/photo/<?php echo $image->image;?>?<?php echo time(); ?>"><img src="<?php echo base_url();?>uploads/thumb_photo/<?php echo $image->image;?>" alt="" class="img-responsive"></a>

...
IF not EXISTS (SELECT column_name
               ...
               WHERE table_schema='public' and table_name='cometchat_users' and column_name='email') THEN
alter table cometchat_users add column email varchar(60) default NULL ;
else

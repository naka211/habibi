...
function index() {
	global $body, $currentversion,$writableDir, $client, $ts, $livesoftware, $marketplace, $plan, $planInfo,$planId,$licensekey,$accessKey,$planName, $dbms;
	$firstGraphTypeOption = $secondGraphTypeOption = $graphdropdown = $report = $dropdown = $range = '';
...
EOD;
		...
		if(!file_exists($writableDir.DIRECTORY_SEPARATOR.'updates'.DIRECTORY_SEPARATOR.$available_version.DIRECTORY_SEPARATOR.'cometchat.zip')){

...
/* START: Offline Email Notification*/
if ((!empty($_REQUEST['cron']['type']) && $_REQUEST['cron']['type'] == "emailnotification") ) {
	$filename = dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."emailnotification".DIRECTORY_SEPARATOR."index.php";
	if (file_exists($filename)) {
		include_once($filename);
	}
	exit();
}
/* END: Offline Email Notification*/

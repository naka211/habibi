        ...
        return {
                    ...
                    if(typeof(message) != 'undefined' && message != '') {
                        ...
                        if($("#cometchat_groupmessage_"+incomingid).length > 0) {
                            ...
                            if(!incomingself) {
                                ...
                                var fromavatar = '<a class="cometchat_floatL" href="'+jqcc.cometchat.getThemeArray('buddylistLink', fromid)+'"><img class="cometchat_userscontentavatarsmall cometchat_avatar_'+fromid+'" src="'+avatar+'" title="'+fromname+'" onerror="this.onerror=null;this.src=\'' + defaultAvatarURL + '\'"/></a>';
                ...
                updateChatroomUsers: function(item,fetchedUsers) {
                    ...
                    $.each(item, function(i,user) {
                        ...
                        if(parseInt(user.b)!=1) {
                            ...
                            var defaultAvatarURL = staticCDNUrl + 'admin/images/pixel.png';
                            var showavatar = '<div class="cometchat_userscontentavatar"><img class="cometchat_userscontentavatarimage" src="'+user.a+'" onerror="this.onerror=null;this.src=\'' + defaultAvatarURL + '\'"></div>';
                ...
                displayChatroomMessage: function(item,fetchedUsers) {
                    ...
                    $.each(item, function(i, incoming) {
                            ...
                            if (message != '' && typeof(message) != 'undefined') {
                                ...
                                if($("#cometchat_groupmessage_"+incoming.id).length > 0) {
                                    ...
                                    if(!incomingself) {
                                        ...
                                        var defaultAvatarURL = staticCDNUrl + 'admin/images/pixel.png';
                                        var fromavatar = '<a class="cometchat_floatL"><img class="cometchat_userscontentavatarsmall cometchat_avatar_'+incoming.fromid+'" src="'+avatar+'" title="'+fromname+'" onerror="this.onerror=null;this.src=\'' + defaultAvatarURL + '\'"/></a>';
                        ...
                        if (message != '' && parseInt(jqcc.cometchat.getExternalVariable('lastgroupmessageid')) < parseInt(incoming.id)){
                             if (typeof(jqcc[jqcc.cometchat.getChatroomVars('calleeAPI')].addMessageCounter) == "function" && !incomingself){
                                if ((typeof $.cookie(settings.cookiePrefix+"sound") == 'undefined' || $.cookie(settings.cookiePrefix+"sound") == null) || $.cookie(settings.cookiePrefix + "sound") == 'true') {
                                    $[calleeAPI].playSound(0);
                                }
                        ...
                        $.each(data, function(i, incoming){
                            ...
                            if (message != '') {
                                ...
                                if (incoming.fromid != settings.myid || (incoming.hasOwnProperty('botid') && incoming.botid != 0)) {
                                    ...
                                    var defaultAvatarURL = staticCDNUrl + 'admin/images/pixel.png';
                                    var fromavatar = '<a class="cometchat_floatL" href="'+jqcc.cometchat.getThemeArray('buddylistLink', incoming.fromid)+'"><img class="cometchat_userscontentavatarsmall cometchat_avatar_'+incoming.fromid+'" src="'+avatar+'" title="'+fromname+'" onerror="this.onerror=null;this.src=\'' + defaultAvatarURL + '\'"/></a>';

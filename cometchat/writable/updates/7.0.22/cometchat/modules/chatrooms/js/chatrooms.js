...
jqcc.extend(jqcc.cometchat, {
    crvariables : {themename: '<?php echo $layout;?>',
            ...
            addCRCSChannel: function(groupid, userid, cometid){
                ...
                var subscribeGroups = jqcc.cometchat.getChatroomVars('subscribeCometGroups');
                if(subscribeGroups.indexOf(cometid) == -1){
                    chatroomcall_function(cometid,userid);
                    subscribeGroups.push(cometid);
                    jqcc.cometchat.setChatroomVars('subscribeCometGroups',subscribeGroups);
                }
            },

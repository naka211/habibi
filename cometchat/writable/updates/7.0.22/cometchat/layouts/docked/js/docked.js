    ...
    $.ccdocked = (function(){
        ...
        return {
            ...
            recentList: function(item){
                ...
                $("div.cometchat_recentcontentavatar").find("img").attr('onError',"this.onerror=null;this.src='"+staticCDNUrl+"admin/images/pixel.png'");
            },
            ...
            addMessages: function(item){
                var todaysdate = new Date(),
                    ...
                    lastrecievedid = jqcc.cometchat.getExternalVariable('lastrecievedid');
                ...
                $.each(item, function(i, incoming){
                    ...
                    if(settings.autoPopupChatbox==1 && incoming.self==0 && incoming.old !=1 && jqcc.cometchat.getCcvariable()['timestamp']<incoming.id) {
                    ...
                    if(incoming.old != 1 && incoming.self != 1 && lastrecievedid < incoming.id){
                        if((typeof $.cookie(settings.cookiePrefix+"sound") == 'undefined' || $.cookie(settings.cookiePrefix+"sound") == null) || $.cookie(settings.cookiePrefix+"sound")=='true'){
                    ...
                    $("div.cometchat_chatboxmessage").find("img").attr('onError',"this.onerror=null;this.src='"+staticCDNUrl+"admin/images/pixel.png'");
                });
            },

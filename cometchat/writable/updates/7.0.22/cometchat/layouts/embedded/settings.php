...
EOD;
            ...
            if (empty($_POST['onlygroup'])) {
                ...
                $cmscode = '';
                if(method_exists($GLOBALS['integration'], 'isPluginActive') && $GLOBALS['integration']->isPluginActive('cometchat') || (!empty($client) && $cms == 'wordpress')){
            ...
            $htmlEmbedCode = '<h6 id="admin-modal-title" class="modal-title" style="padding: 20px 0px 3px 0px;">HTML Embed Code</h6><textarea readonly="" class="form-control" style="width:100%;height:180px">'.$embed_code.'</textarea>';

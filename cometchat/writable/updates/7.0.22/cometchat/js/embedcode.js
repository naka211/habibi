...
(function($){
	$.cometchat = (function(){
		return {
			...
			audiovideocall: function(uid,cccloud){
				if(typeof(uid) != 'undefined' || uid != null || uid != ''){
					uid = 0;
				}
				var controlparameters = {"type":"modules", "name":"cometchat", "method":"audiovideocall", "params":{"uid":uid,"cccloud":cccloud}};
				controlparameters = JSON.stringify(controlparameters);
   				if(typeof(jqcc('#cometchat_synergy_iframe')[0]) != 'undefined'){
   					jqcc('#cometchat_synergy_iframe')[0].contentWindow.postMessage('CC^CONTROL_'+controlparameters,'*');
   				}
			},
			audiocall: function(uid,cccloud){
				if(typeof(uid) != 'undefined' || uid != null || uid != ''){
					uid = 0;
				}
				var controlparameters = {"type":"modules", "name":"cometchat", "method":"audiocall", "params":{"uid":uid,"cccloud":cccloud}};
				controlparameters = JSON.stringify(controlparameters);
   				if(typeof(jqcc('#cometchat_synergy_iframe')[0]) != 'undefined'){
   					jqcc('#cometchat_synergy_iframe')[0].contentWindow.postMessage('CC^CONTROL_'+controlparameters,'*');
   				}
			},
			screenshare: function(uid,cccloud){
				if(typeof(uid) != 'undefined' || uid != null || uid != ''){
					uid = 0;
				}
				var controlparameters = {"type":"modules", "name":"cometchat", "method":"screenshare", "params":{"uid":uid,"cccloud":cccloud}};
				controlparameters = JSON.stringify(controlparameters);
   				if(typeof(jqcc('#cometchat_synergy_iframe')[0]) != 'undefined'){
   					jqcc('#cometchat_synergy_iframe')[0].contentWindow.postMessage('CC^CONTROL_'+controlparameters,'*');
   				}
			},
			whiteboard: function(uid,cccloud){
				if(typeof(uid) != 'undefined' || uid != null || uid != ''){
					uid = 0;
				}
				var controlparameters = {"type":"modules", "name":"cometchat", "method":"whiteboard", "params":{"uid":uid,"cccloud":cccloud}};
				controlparameters = JSON.stringify(controlparameters);
   				if(typeof(jqcc('#cometchat_synergy_iframe')[0]) != 'undefined'){
   					jqcc('#cometchat_synergy_iframe')[0].contentWindow.postMessage('CC^CONTROL_'+controlparameters,'*');
   				}
			},
			broadcast: function(uid,chatroommode,cccloud){
				if(typeof(uid) != 'undefined' || uid != null || uid != ''){
					uid = 0;
				}
				var controlparameters = {"type":"modules", "name":"cometchat", "method":"broadcast", "params":{"uid":uid,"chatroommode":chatroommode,"cccloud":cccloud}};
				controlparameters = JSON.stringify(controlparameters);
   				if(typeof(jqcc('#cometchat_synergy_iframe')[0]) != 'undefined'){
   					jqcc('#cometchat_synergy_iframe')[0].contentWindow.postMessage('CC^CONTROL_'+controlparameters,'*');
   				}

				...
				if(typeof(e.data) != 'undefined' && typeof(e.data) == 'string'){
					if(e.data.indexOf('ccmobile_reinitializeauth')!== -1){
						...
						if(controlparameters.type == "extensions" && controlparameters.name == "jabber" && controlparameters.method == "login_gtalk"){
							...
							if(controlparameters.hasOwnProperty('name') && controlparameters.name != 'undefined' && controlparameters.hasOwnProperty('method') && controlparameters.method != 'undefined' && typeof(jqcc[controlparameters.name][controlparameters.method]) == 'function'){
							...
							if(typeof(controlparameters.params.caller)=="undefined"){
								...
								}else if(controlparameters.method == "audiovideocall" || controlparameters.method == "audiocall" || controlparameters.method == "screenshare" || controlparameters.method == "whiteboard"){
									jqcc[controlparameters.name][controlparameters.method](controlparameters.params.uid,controlparameters.params.cccloud);
								}else if(controlparameters.method == "broadcast"){
									jqcc[controlparameters.name][controlparameters.method](controlparameters.params.uid,controlparameters.params.chatroommode,controlparameters.params.cccloud);
								} else {
							...
							if(controlparameters.params.chatroommode == 1 && controlparameters.method != "init" && typeof(jqcc.cometchat) != 'undefined' && typeof(jqcc.cometchat) == 'function' && jqcc.cometchat.getSettings().theme != 'synergy' && jqcc.cometchat.getSettings().theme != 'embedded' && jqcc.cometchat.getSettings().theme != 'docked'){
...
function outgoingCall(id,grp,userdata,calltype){
	...
	var defaultAvatarURL = staticCDNUrl + 'admin/images/pixel.png';
...
function incomingCall(incoming,avchat_data,currenttime,userdata){
	...
	var buddylistAvatar = userdata.avatar;
	var acceptcalltype = rejectcalltype = type = '';
	var clientTime = new Date(incoming.sent*1000).getTime()/1000;
	...
	var defaultAvatarURL = staticCDNUrl + 'admin/images/pixel.png';
	if(jqcc("#avchat_container_"+incoming.from).length==0 && (clientTime > currenttime - 15)){
...
/**
  * checkBrowser
  * returns array containing browser name and its version
  * @param - no parameter
*/
